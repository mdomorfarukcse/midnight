...
<html lang="en">
<head>
     <title><?= $language::translate('Delivery Information') ?> - <?= SITE_NAME ?> </title>
	<?php include("css.php")?>
             ...
             <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 layout-top-spacing">
                 <div class="skills layout-spacing ">
                     <div class="widget-content widget-content-area">
                       <h3 style="    font-size: 40px;    margin: 24px 0px 22px 0;    text-align: center;" class=""><?= $language::translate('Delivery Information') ?></h3>
                       <div style=" padding-top: 8px !important; padding: 43px;">
  <?=$setting->getDescription3();?>
</div>
                     </div>
                 </div>
             </div>
