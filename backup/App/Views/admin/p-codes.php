...
$pCodes = $container->has('detailId') ? (new PCodes())->find($container->get('detailId')) : new PCodes();

if ($request->isMethod('post')) {

    try {

        $new = empty($pCodes->getId());
        ...
        if ($new) header('location: /admin/p-codes/detail/' . $pCodes->getId() . '?confirm_message=Success');
        ...
        <div class="layout-px-spacing">
            <div class="row layout-top-spacing">
                <div class="col-xl-6 col-lg-6 col-sm-12 ">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title"><?= $language::translate('P Codes') ?></h5>
                            <form action="" method="post" enctype="multipart/form-data" style="width: 100%">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="code" class="form-control" id="code" value="<?= $pCodes->getCode() ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="description" class="col-sm-2 col-form-label"> <?= $language::translate('Description') ?></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="description" class="form-control" id="description" value="<?= $pCodes->getDescription() ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-check">
                                            <label class="checkbox-inline">
                                                <input type="checkbox" value="1" name="is_active" <?= !$pCodes->getIsActive() ?: 'checked'; ?> data-toggle="toggle">
                                            </label>
                                        </div>
                                    </div>
                                </div>
