...
<body>
    ...
    <div class="main-container" id="container">
                ...
                <div class="row layout-top-spacing">
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                            <a href="/admin/sms-provider/new" class="btn btn-outline-info btn-sm col-md-12 new-entity-button"><i
                                        class="ti-plus"></i> <?= $language::translate('Sms Provider') ?></a>
                            <table id="sms-provider-list-datatable" class="table table-striped" style="width:100%"></table>
                        </div>
                    </div>
                </div>
            </div>
        ...
        function getCustomerListData() {
            ...
            var customerDataTable = $('#sms-provider-list-datatable').dataTable({
                processing: true,
                serverSide: true,
                destroy: true,
                lengthMenu: [
                ...
                columns: [{
...

                    {
                        ...
                        render: function(id) {
                            var operationHtml =
                                '<a class="btn btn-outline-info btn-sm operation-icons" href="/admin/sms-provider/detail/' +
                ...
                ajax: {
                    type: "POST",
                    url: "/ajax/admin/customer/sms-list-for-datatable",
                    data: function(data) {

                        var settings = $("#sms-provider-list-datatable").dataTable().fnSettings();
        ...
        function getCustomerListDataTable() {
            return $('#sms-provider-list-datatable');
        }
        </script>
        <style>
