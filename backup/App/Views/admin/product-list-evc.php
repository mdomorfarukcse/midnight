...
$products = (new ProductEvc())->findAll();
...
<html lang="en">
<head>
    <title>EVC <?= $language::translate('Products') ?> - <?= SITE_NAME ?> </title>
    <?php include("css.php")?>
            ...
            <div class="row layout-top-spacing">
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    <div class="widget-content widget-content-area br-6">
                        <a href="/admin/product-evc/new" class="btn btn-outline-info btn-sm col-md-12 new-entity-button"><i class="ti-plus"></i>Evc <?= $language::translate('Products') ?></a>
                            ...
                            if (!empty($products)) {
                                ...
                                foreach ($products as $product) { ?>
                                    <tr>
                                        ...
                                        <td><a class="btn btn-outline-info btn-sm operation-icons" href="/admin/product-evc/detail/<?= $product->getId() ?>"><i class="ti-pencil-alt"></i></td>
                                    </tr>
                                <?php }
                            }
                            ?>
