    ...
    public function list()
    {
        $this->container->set('page',
            (new Page())
                ...
                ->setMetaTitle('EVC Products - ' . $this->setting->getSiteName())
                ->setMetaDescription('EVC Products - ' . $this->setting->getDescription())
        );

        View::render('admin','product-list-evc', []);
    } 
