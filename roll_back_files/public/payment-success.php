					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                        <div class="widget widget-four">
                            <div class="widget-heading">
                                <h5 class=""><?= $language::translate('Payment Status') ?></h5>
                            </div>
...
<center><?= $language::translate('Successful! We will process your payment into your account within a few minutes.') ?></center>
</div>
                                    </div>
                                 </div>
                            </div>
