...
foreach ($_REQUEST['items'] as $orderItem) {
    $BasketItem = new \Iyzipay\Model\BasketItem();
    $BasketItem->setId($orderItem['purchase_token']);
    $BasketItem->setName($orderItem['item_name']);
    $BasketItem->setCategory1($orderItem['item_name']);
    $BasketItem->setItemType(\Iyzipay\Model\BasketItemType::VIRTUAL);
    $BasketItem->setSubMerchantKey($orderItem['subMerchantKey']);
    $BasketItem->setSubMerchantPrice($orderItem['subMerchantPrice']);
    $BasketItem->setPrice($orderItem['price_amount']);
