...
class SupportMail
{
    public static function new(Support $support)
    {
        global $container;
                                                ...
                                                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td style="padding:0 35px;">
                                                            <h1 style="color:#1e1e2d; font-weight:500; margin:0;font-size:28px;font-family: \'Open Sans\', sans-serif;">Your support request has been created</h1>
                                                            <span style="display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;"></span>
                                                            <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                                                Customer :  ' . $support->getCustomer()->getFullName() . '  <br>
                                                                Subject :  ' . $support->getSubject() . '  <br>
																Vehicle :  ' . (($support->getVehicle() && $support->getVehicle() != "") ? $support->getVehicle():'-') . '  <br>
                                                                Message :  ' . $support->getText() . '  <br>
    ...
    public static function reply(Support $support)
    {
        global $container;
                                        ...
                                        <tr>
                                            <td>
                                                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td style="padding:0 35px;">
                                                            <h1 style="color:#1e1e2d; font-weight:500; margin:0;font-size:28px;font-family: \'Open Sans\', sans-serif;">Your support request has been replied.</h1>
                                                            <span style="display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;"></span>
                                                            <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                                            Subject :  ' . $support->getSubject() . '  <br>
																Vehicle :  ' . (($support->getVehicle() && $support->getVehicle() != "") ? $support->getVehicle():'-') . '  <br>
                                                                Reply :  ' . $support->getText() . '  <br>
                                                                Date :  ' . date('Y-m-d H:i') . '  <br>
    ...
    public static function replyCustomer(Support $support)
    {
        global $container;
