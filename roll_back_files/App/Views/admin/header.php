...
<style>
	.topbtn{
       ...
       echo $date->format("H:i:s");?>
			  ...
			  <li>
				  <h5><a href="/admin/customer/vehicle/list" class="btn btn-info btn-sm topbtn">Pending: <span class="badge badge-light"><?= $VehiclePendingCount ?></span></a>  </h5>
			  </li>
			  <li>
				  <h5><a href="/admin/customer/vehicle/list" class="btn btn-success btn-sm topbtn">Processing: <span class="badge badge-light"><?= $VehicleProcessingCount ?></span></a>  </h5>
			  </li>
          </ul>
