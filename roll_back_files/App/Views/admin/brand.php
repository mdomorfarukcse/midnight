...
if ($request->isMethod('post')) {
    ...
    try {
        ...
        if ($new) header('location: /admin/vehicle/brand/detail/' . $brand->getId() . '?confirm_message=Success');
...
<html lang="en">
<head>
    <title><?= $language::translate('Brand') ?> - <?= SITE_NAME ?> </title>
    <?php include("css.php")?>
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post" enctype="multipart/form-data" style="width: 100%">
                                ...
                                <div class="form-group row">
                                    <label for="parent_id" class="col-sm-2 col-form-label"> <?= $language::translate('Type') ?></label>
                                    <div class="col-sm-10">
                                        <select name="parent_id" id="status" class="form-control" style="width: 50%">
                                            <option value=""><?= $language::translate('Vehicle Type') ?></option>
                                            <?php
                                            /* @var Category $type */
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <img id="img-upload"src="<?= $brand->getImage(true) ?>" style="width: 100px"/>
                                    </div>
                                </div>
