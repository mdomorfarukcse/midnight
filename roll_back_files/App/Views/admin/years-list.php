              ...
              language : {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        className: "dt-center",
                        render: function(model_name) {
                            return model_name;
                        }
                    },
                    {
                        data: "name",
                        title: "<?= $language::translate('Year') ?>",
                        className: "dt-center",
                    ...
                    },
                    {
                        ...
                        render: function(id) {
                            var operationHtml =
                                '<a class="btn btn-outline-info btn-sm operation-icons" href="/admin/vehicle/years/detail/' +
                ...
                ajax: {
                    type: "POST",
                    url: "/ajax/admin/years/list-for-datatable",
                    data: function(data) {
